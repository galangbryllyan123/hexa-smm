...
// end paging config
												while ($data_order = $new_query->fetch_array(MYSQLI_ASSOC)) {
												...
												?>
													<tr class="table-<?php echo $label; ?>">
														...
														<td><a href="javascript:;" onclick="get_detail('<?php echo $site_config['base_url']; ?>order/detail_order?oid=<?php echo $data_order['oid']; ?>')" class="btn btn-info btn-sm" title="Detail"><i class="fa fa-eye"></i></a></td>		
														...
														<td align="center"><span class="badge badge-<?php echo $label; ?>"><?php echo $data_order['status']; ?></span></td>					<td><?php if($data_order['place_from'] == "API") { ?><span class="badge badge-success"><i class="fa fa-check"></i></span><?php } else { ?><span class="badge badge-danger"><i class="fa fa-times"></i></span><?php } ?></td>
