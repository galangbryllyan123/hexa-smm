...
if (isset($_POST['method'])) {
	$method = $db->real_escape_string(stripslashes(strip_tags(htmlspecialchars($_POST['method'], ENT_QUOTES))));
	$check_service = $db->query("SELECT * FROM deposit_method WHERE id = '$method'");
