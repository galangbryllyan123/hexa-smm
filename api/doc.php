			                ...
			                <div class="row">
                                <div class="col-md-12">
                                    <div class="card-box">
                                       ...
                                       <h3 class="text-bold">Informasi Dasar</h4>
											<table class="table table-bordered">
												<tbody>
													...
													<tr>
														<td>API URL</td>
														<td><?php echo $site_config['base_url']; ?>api/json.php</td>
													</tr>
													<tr>
										...
										<h3 class="text-bold">Membuat Pesanan</h4>
											<table class="table table-bordered">
												<thead>
													<tr>
														<th>Parameter</th>
						                        ...
						                        <tr>
							                        ...
							                        <td>Diisi dengan id layanan, silahkan lihat <a href="<?php echo $site_config['base_url']; ?>services">daftar harga</a>.</td>
						                        </tr>
						                        <tr>
							                        <td><code>link</code></td>
							                        <td>Diisi dengan data link/url/username yang ditargetkan pesanan.</td>
					                            </tr>
						                        <tr>
						                        	<td><code>quantity</code></td>
						                        	<td>Diisi dengan jumlah yang ingin dipesan.</td>
					                           	</tr>
...
<br />
											<h3 class="text-bold">Mengecek Status Pesanan</h4>
											<table class="table table-bordered">
												<thead>
													<tr>
														<th>Parameter</th>
